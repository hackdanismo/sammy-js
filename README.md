...
+ `Unminified`: `sammy-1.0.3.js`
+ `Minified`: `sammy-1.0.3.min.js`

The library can be added using a `<script>` tag in the `HTML`:

```html
<!-- Minified (Recommended) -->
<script src="https://hackdanismo.github.io/sammy-js/scripts/sammy-1.0.3.min.js"></script>

<!-- Unminified -->
<script src="https://hackdanismo.github.io/sammy-js/scripts/sammy-1.0.3.js"></script>
```
